  ...
  return (
    ...
    >
      <div className="flex w-full justify-around">
        ...
        <NavLink to={`/discharge/${activeStation()}`} className={itemClass}>
          <i className="bi bi-truck" />
          <span>Discharge</span>
        </NavLink>
        <NavLink to={`/summary/${activeStation()}`} className={itemClass}>
          <i className="bi bi-printer" />
          <span>Summary</span>
        </NavLink>
        <NavLink to={`/payroll/${activeStation()}`} className={itemClass}>
